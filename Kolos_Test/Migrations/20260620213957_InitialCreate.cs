    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1999.2m, "budynek dla cweli", "Kurs dla cweli v1" },
                    { 2, 3299.2m, "budynek dla cweli v2", "Kurs dla cweli v2" }
                });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "StudentId", "Email", "EnrollmentId", "FirstName", "LastName" },
                values: new object[,]
                {
                    { 1, "Cwelisko@chuj.pl", 1, "cwel", "cwelisko" },
                    { 2, "pedal@cwel.pl", 2, "pedal", "pedalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "jestemcwelem@gmail.com", "ss", "dsdsd" },
                    { 2, 2, "jestemcwelem235@gmail.com", "fdff", "dfsfds" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 283, 1, 1, "Kurs dla cweli v1" },
                    { 2, 100, 2, 4, "Kurs dla cweli v2" }
                });
